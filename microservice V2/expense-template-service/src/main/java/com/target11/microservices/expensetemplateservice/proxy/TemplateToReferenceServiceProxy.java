...
public interface TemplateToReferenceServiceProxy {
	...
	@PostMapping(value = "/reference/getDesc/categoryIdList", headers = "Accept=application/json")
	public Map<String, String> getCategoryDescList(@RequestBody List<String> categoryIdList);
	
	
	@PostMapping(value = "/reference/getDesc/tagDesclist", headers = "Accept=application/json")
